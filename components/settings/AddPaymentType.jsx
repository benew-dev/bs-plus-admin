...
const AddPaymentType = () => {
  ...
  const platforms = [
    ...
    // Nouveau: option paiement en espèces
    {
      value: "CASH",
      label: "ESPÈCES",
  ...
  const isCashPayment = platform === "CASH";
  ...
  const submitHandler = (e) => {
    ...
    // Si c'est un paiement CASH, pas besoin de valider les autres champs
    if (isCashPayment) {
      // Envoyer avec des valeurs par défaut pour CASH
      newPaymentType(platform, "Paiement en espèces", "N/A");
      return;
    }

    // Pour les paiements électroniques, validation stricte
      ...
      <div className="max-w-2xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-slate-600">
            Ajoutez une plateforme de paiement mobile ou espèces
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden">
          <div className="bg-gradient-to-r from-green-500 to-emerald-500 p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-white/80">Maximum 5 moyens autorisés</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-8 space-y-6">
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-emerald-700">
                      Cette option permet aux clients de payer en espèces lors
                      de la récupération de leur commande. Aucune information de
            ...
            {/* Champs conditionnels - masqués pour CASH */}
            {!isCashPayment && (
              <>
                {/* Nom du titulaire */}
                <div className="group">
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-blue-700">
                        ...
                        clients. Assurez-vous qu'il appartient bien à la
                        personne indiquée.
                      </p>
                    </div>
                  </div>
                ...
                {isCashPayment ? (
                  <div className="space-y-2">
                    ...
                    <p className="text-white/70 text-xs">
                      Les clients paieront directement lors de la récupération
                    </p>
                  </div>
                ) : (
                  <>
            ...
            <div className="flex gap-4 pt-4">
              <button
                ...
                disabled={
                  !platform ||
                  (!isCashPayment &&
                    (!accountHolderName.trim() || !platformNumber.trim()))
                }
